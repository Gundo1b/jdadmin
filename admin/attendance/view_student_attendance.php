...
<div class="container-fluid">
    <h3 class="mb-4"><i class="bi bi-eye"></i> View Student Attendance</h3>
        ...
        <div class="card-body">
            <form action="" method="GET" class="row g-3 align-items-end">
                ...
                <div class="col-md-6 text-end">
                    <a class="btn btn-outline-secondary" href="<?php echo BASE_URL; ?>admin/attendance/daily_student.php?date=<?php echo urlencode($attendance_date); ?>&grade_id=<?php echo $selected_grade_id; ?>&class_id=<?php echo $selected_class_id; ?>">
